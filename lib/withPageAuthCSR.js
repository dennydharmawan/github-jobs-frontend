...
const defaultOnRedirecting = () => <>Redirecting you to login Page...</>;
const defaultOnError = () => <></>;

import { useQuery } from '@tanstack/react-query';
import axios from 'axios';

export default function withPageAuthCSR(Component, options = {}) {
  return function WithPageAuthRequired(props) {
    ...
    if (willRedirect && !user?.isAuthenticated) return onRedirecting();
